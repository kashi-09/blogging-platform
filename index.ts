...
let author1:Author =  {id:123 ,name:"Kashif", bio:"abc"}
let author2:Author =  { id:456 ,name:"Haris", bio:"xyz"}
let author3:Author =  { id:789 ,name:"Khurram", bio:"rwp"}
...
function sortedPosts(Posts:Post[]){
